      ...
      <div className="max-w-7xl mx-auto px-4 flex items-center justify-between h-16">
        ...
        <nav className="hidden lg:flex items-center gap-1">
          {blok.nav_items?.map((item) => (
            <button
              ...
              className="px-3 py-2 text-sm font-semibold text-gray-600 hover:text-[hsl(174,70%,28%)] transition-colors font-['Montserrat'] rounded-lg hover:bg-gray-100"
            >
              {item.label}
            </button>
          ))}
        ...
        <div className="flex items-center gap-3">
          <a
            ...
            className="hidden sm:flex items-center gap-2 bg-[hsl(174,70%,28%)] text-white font-bold px-4 py-2.5 rounded-full hover:bg-[hsl(174,70%,22%)] transition-all text-sm font-['Montserrat'] shadow-md hover:shadow-lg"
          >
        ...
        <div className="lg:hidden border-t border-gray-200 bg-white px-4 py-3 space-y-1">
          {blok.nav_items?.map((item) => (
            <button
              ...
              className="block w-full text-left px-3 py-2.5 text-sm font-semibold text-gray-600 hover:text-[hsl(174,70%,28%)] hover:bg-gray-100 rounded-lg transition-colors font-['Montserrat']"
            >
              {item.label}
            </button>
          ))}
          <a
            href={`tel:${blok.phone.replace(/\s/g, "")}`}
            className="flex items-center justify-center gap-2 bg-[hsl(38,92%,64%)] text-gray-900 font-bold px-4 py-3 rounded-xl mt-2 text-sm font-['Montserrat']"
          >
