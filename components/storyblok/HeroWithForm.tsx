"use client";
import { Phone, Mail, Send, CheckCircle, Star } from "lucide-react";
...
export default function HeroWithForm({ blok }: HeroWithFormProps) {
  ...
  const badges = blok.trust_badges && blok.trust_badges.length > 0 ? blok.trust_badges : defaultBadges;
    ...
    >
      ...
      <div className="relative z-10 w-full max-w-7xl mx-auto px-4 py-10 flex flex-col lg:flex-row items-center gap-10 lg:gap-16">
          ...
          <div className="bg-white rounded-2xl shadow-2xl border border-gray-200 p-6 lg:p-7">
            ...
            <div className="flex gap-2 mb-4">
              ...
              <a
                ...
                className="flex-1 flex items-center justify-center gap-1.5 bg-gray-100 text-gray-900 font-semibold py-2.5 rounded-lg text-xs hover:bg-gray-200 transition-colors"
              >
            ...
            <div className="relative mb-4">
              ...
              <div className="relative flex justify-center">
                <span className="bg-white px-3 text-xs text-gray-500">or fill the form</span>
              </div>
            </div>
            ...
            {submitted ? (
              ...
              <form onSubmit={handleSubmit} className="space-y-3">
                ...
                <p className="text-center text-xs text-gray-500">🔒 Your details are safe with us. No spam, ever.</p>
              </form>
            )}
          </div>
        </div>
        ...
        <div className="flex-1 text-white order-first lg:order-last text-center lg:text-left">
          ...
          <h1
            className="font-black leading-tight mb-4 drop-shadow-md"
            style={{ fontSize: "clamp(2rem, 4.5vw, 3.8rem)" }}
            dangerouslySetInnerHTML={{ __html: blok.heading }}
          />
