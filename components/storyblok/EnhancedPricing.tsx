    ...
    <section id="pricing" className="py-16 lg:py-24 bg-white">
      <div className="max-w-7xl mx-auto px-4">
        <div className="text-center mb-12">
          <span className="inline-block bg-[hsl(37,91%,55%)]/10 text-[hsl(37,91%,55%)] text-xs font-bold px-3 py-1 rounded-full mb-3">
            PRICING
          </span>
            ...
            return (
              <div
                ...
                className={`relative bg-white rounded-xl p-6 ${
                  tier.is_popular
                    ? 'border-2 border-[hsl(174,65%,28%)] shadow-xl scale-105'
                    : 'border border-gray-200 shadow-md'
                } transition-all hover:shadow-xl`}
              >
                {tier.is_popular && (
                  <div className="absolute -top-3 left-1/2 -translate-x-1/2 bg-[hsl(37,91%,55%)] text-gray-900 text-xs font-black px-4 py-1 rounded-full shadow-md">
                    BEST VALUE
                  </div>
                )}
                ...
                <div className="text-center mb-6 mt-2">
                  ...
                  <div className="text-4xl font-black text-[hsl(174,65%,28%)]">
                    {tier.price}
                  </div>
                </div>
                ...
                <ul className="space-y-3 mb-6">
                  {features.map((feature, idx) => (
                    <li key={idx} className="flex items-start gap-2">
                      <Check className="w-5 h-5 text-[hsl(174,65%,28%)] flex-shrink-0 mt-0.5" />
        ...
        <p className="text-center text-sm text-gray-600 mt-8">
          ...
          <button className="text-[hsl(174,65%,28%)] font-semibold hover:underline">
            Contact us
          </button>{' '}
