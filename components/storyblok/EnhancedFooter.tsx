        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-8">
          <div>
            ...
            <a
              ...
              className="inline-flex items-center gap-2 bg-[hsl(174,70%,28%)] text-white font-bold px-4 py-2.5 rounded-full hover:bg-[hsl(174,70%,22%)] transition-all text-sm shadow-md"
            >
              ...
              {navLinks.map(({ label, href }) => (
                <li key={href}>
                  <button
                    ...
                    className="text-gray-400 hover:text-[hsl(38,92%,64%)] transition-colors text-sm"
                  >
                    {label}
                  </button>
                </li>
          ...
          <div>
            ...
            <div className="space-y-3">
              <a
                href={`tel:${blok.phone.replace(/\s/g, '')}`}
                className="flex items-center gap-2 text-gray-400 hover:text-[hsl(38,92%,64%)] transition-colors text-sm"
              >
                <Phone className="w-4 h-4" />
                {blok.phone}
              </a>
