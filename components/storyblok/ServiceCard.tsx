...
export default function ServiceCard({ blok }: ServiceCardProps) {
  ...
  return (
    <div
      ...
      className="group bg-white border border-gray-200 rounded-2xl p-6 hover:shadow-xl hover:border-[hsl(174,70%,28%)]/30 hover:-translate-y-1 transition-all"
    >
      {blok.tag && (
        <span className="inline-block bg-[hsl(38,92%,64%)]/10 text-[hsl(38,92%,64%)] text-[10px] font-black px-2 py-0.5 rounded-full mb-3 font-['Montserrat']">
          {blok.tag}
        </span>
      )}
      <div className="w-12 h-12 bg-[hsl(174,70%,28%)]/10 rounded-xl flex items-center justify-center mb-4 group-hover:bg-[hsl(174,70%,28%)]/20 transition-colors">
        <IconComponent className="w-6 h-6 text-[hsl(174,70%,28%)]" />
      </div>
      ...
      <button
        ...
        className="flex items-center gap-1 text-[hsl(174,70%,28%)] font-bold text-xs font-['Montserrat'] hover:gap-2 transition-all"
      >
