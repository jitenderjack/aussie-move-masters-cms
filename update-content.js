...
const STORY_ID = '150916839317706';
...
async function updateStory() {
  console.log('Updating landing page story...\n');
  ...
  try {
    const result = await apiCall(`/stories/${STORY_ID}`, 'PUT', storyData);
    console.log('✅ Landing page updated successfully!');
    console.log(`\nView it at: https://app.storyblok.com/#!/me/spaces/${SPACE_ID}/stories/0/0/${STORY_ID}`);
    console.log('\nNext: Publish the page in Storyblok to make it live!');
  } catch (error) {
